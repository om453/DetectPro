...
const HomePage = (props: Props) => {
  ...
  useEffect(() => {
    setLoading(true);
    initModel();  // this function loads the model
  }, [])
  ...
  }, [model]) // when model is loaded, set loading to false


  // this function runs the prediction on the video feed
  ...
  return (
    <div className="flex h-screen">
      {/* Right devision - webcam and canvas */}
      <div className=" relative">
        <div className="relative w-full h-screen">
          ...
          {/* Using canvas to show detective objects as in red color */}
          <canvas
            ref={canvasRef}
      ...
      <div className="h-full py-4 px-2 overflow-y-scroll">
  ...
  // This function is used to record the video manually
  ...
  function startRecording(doAudio: boolean) {
    if (webcamRef.current && mediaRecorderRef.current?.state !== 'recording') {
      mediaRecorderRef.current?.start();
      doAudio && audio(volume);
